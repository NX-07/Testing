...
def cadastrar(): #cadastro de filmes 2 
    nome = str(input("Cadastrar nome do filme: "))
    print("Gêneros cadastraveis:")
    print("1 - Drama | 2 - Ação | 3 - Animação | 4 - Suspense | 5 - Policial | 6 - Comedia | 7 - Ficção")
    genero = str(input("Escolha o gênero (1 a 7): "))
    if genero == "1":
        genero = "Drama"
    elif genero == "2":
        genero = "Ação"
        ...
        genero = "Ficção"
    ano = str(input("Cadastre o ano do filme (AAAA): "))
    disponivel = str(input("O filme está disponível? (Sim/Não): "))
    filmes = {
